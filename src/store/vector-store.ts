 ...
 * column, so the equivalent rule is structural: the row stays (the channel transcript is still the
 * channel transcript) but it is not a relevance candidate. Raziel's lines (companion NULL) stay
