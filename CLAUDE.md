...
| ~~C2~~ | `src/index-http.ts:67` | `cors({ origin: true, credentials: true })` allows any origin to make credentialed requests — CSRF attack surface. | Restrict to `origin: ["https://claude.ai", "https://mcp.example.com"]` | ✅ Fixed (Fix 13) |
